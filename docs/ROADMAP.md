...
- [~] Pure tests for save migration, swept/resolved collision movement, incremental grass growth, material-aware audio state, frame-rate-independent Finish timing, grass/debris fields, controls, content integrity, and deterministic layouts. Ninety-five tests pass; broader randomized reachability coverage remains.
