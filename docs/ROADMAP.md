...
- [~] Pure tests for save migration, swept/resolved collision movement, incremental grass growth, material-aware audio state, grass/debris fields, controls, content integrity, and deterministic layouts. Ninety-three tests pass; broader randomized reachability coverage remains.
